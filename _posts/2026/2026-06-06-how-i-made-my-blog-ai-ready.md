...
The AI suggestions improved right away. The first time I asked Claude Code to add a new certification entry, it picked the right folder, used the correct front matter fields, and followed the existing naming pattern — without me explaining any of it. That is the payoff.
